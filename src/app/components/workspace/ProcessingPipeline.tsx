...
export function ProcessingPipeline({ status, fileName, fileSize }: Props) {
  const steps = [
    ...
    {
      id: DocumentStatus.Parsing,
      label: "Parse Document",
      icon: Binary,
      activeDesc: "Extracting text and content from file...",
      detail: "Preserving page numbers and paragraph order...",
      progressVal: 35,
    },
    {
      id: DocumentStatus.ExtractingMetadata,
      label: "Extract Metadata",
      icon: Cpu,
      activeDesc: "Extracting and analyzing document metadata...",
      detail: "Calculating file stats and document category...",
      progressVal: 55,
    },
    {
      id: DocumentStatus.GeneratingStatistics,
      label: "Generate Statistics",
      icon: BarChart3,
      activeDesc: "Calculating comprehensive document statistics...",
      detail: "Counting words, sentences, headings, and more...",
      progressVal: 85,
    },
    {
      ...
      label: "Ready",
      icon: Eye,
      activeDesc: "Finalizing workspace setup...",
      detail: "Document is ready for use in the workspace...",
      progressVal: 100,
    },
  ];
